...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-border-soft bg-[radial-gradient(ellipse_at_top,#1e293b_0%,#020617_60%,#000_100%)] px-6 pb-10 pt-8 [html.light_&]:bg-[radial-gradient(ellipse_at_top,#e7e5e4_0%,#f5f5f4_100%)] md:px-10 md:pb-12 md:pt-10 xl:px-16">
