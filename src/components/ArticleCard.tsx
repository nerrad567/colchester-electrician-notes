...
export function ArticleCard({ post }: { post: CardPost }) {
  return (
    ...
    >
      ...
      <h3 className="mb-3 text-base font-bold leading-snug text-text [html.light_&]:text-[#1c1917] sm:text-lg lg:text-xl xl:text-2xl">
        {post.title}
      </h3>
      <p className="mb-auto text-[0.84rem] leading-[1.7] text-muted [html.light_&]:text-[#57534e] sm:text-[0.88rem] lg:text-[0.95rem] lg:leading-[1.8] xl:text-base">
        {post.excerpt}
      </p>
